...
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame"); /*--- 273.7ms ---*/

  /*--- querySelectorAll ->  ---*/
  var items = document.getElementsByClassName('mover');
  // var items = document.querySelectorAll('.mover'); /*--- 1658.3ms ---*/
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 100; i++) {
    ...
    // document.querySelector("#movingPizzas1").appendChild(elem); /*--- this method costs more ---*/
